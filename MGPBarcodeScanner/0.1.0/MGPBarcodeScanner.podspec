#
#  Be sure to run `pod spec lint MGPBarcodeScanner.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.1.0"
  s.summary      = "A light weight, powerful, fast and efficient library to scan Barcode and QR Codes."
  ...
  # Or just: s.author    = "MahendraGP"
  # s.authors            = { "MahendraGP" => "patelarjun81@gmail.com" }
  # s.social_media_url   = "http://twitter.com/MahendraGP"
  ...
  s.source       = { :git => "https://github.com/mahendragp/MGPBarcodeScanner.git", :tag => "0.1.0" }
